  ...
  return (
    <>
      ...
      <main className="mx-auto w-11/12 max-w-screen-xl lg:flex lg:justify-between">
        <div className="flex flex-col justify-between pt-20 lg:sticky lg:top-0 lg:h-screen lg:w-1/3 lg:pb-32">
          <div>
            <h1 className="text-4xl font-bold lg:text-6xl">Rakesh</h1>
            <h2 className="mt-2 ml-0.5 text-xl font-semibold lg:text-2xl">
              Designer, Full-Stack Developer, and Entrepreneur
            </h2>
        ...
        <div className="py-20 lg:w-1/2">
          <h2 className="mb-5 text-sm font-semibold uppercase text-white/60">Projects</h2>
          <Link href="https://joinspots.com/">
            <a className="mt-3 block rounded-sm bg-canvas/80 p-6 transition-all hover:scale-[103%] lg:p-10">
          ...
          <h2 className="mt-20 mb-5 text-sm font-semibold uppercase text-white/60">Work</h2>
          ...
          <Link href="https://supertokens.com/">
            <a className="mt-3 block rounded-sm bg-canvas/80 p-6 transition-all hover:scale-[103%] lg:p-10">
              ...
              <p className="mt-2 text-white/70">Supertoken is a YC startup building open source user auth solutions</p>
        ...
        <div className="mb-16 leading-relaxed text-white/70 lg:hidden">
          If you&apos;d like to talk, just send an email at{' '}
          <Link href="mailto:hey@rakesh.one">
            <a className="border-white/90 py-1 font-medium text-white hover:border-b">hey@rakesh.one</a>
          </Link>
